...
export default function FavoritesPage() {
  ...
  useEffect(() => {
    document.title = "Favorites — SRK Fragrance";
  }, []);
  const saved = products.filter((product) => favorites.includes(product.id));
  return (
    <main id="main">
      <PageHero eyebrow="Your edit" title="Favorites">
        <p>A personal collection of scents worth returning to.</p>
      </PageHero>
      <section className="section container">
        {saved.length ? (
          ...
          <EmptyState
            ...
            message="Save fragrances you love and find them here anytime."
